...
<fieldset>
    ...
    <p></p>
    <legend><?= t('Maximum Width') ?></legend>
    <input type="text" name="maximumWidth" value="<?= $maximumWidth ?>">
    <p></p>
    <legend><?= t('Maximum Height') ?></legend>
    <input type="text" name="maximumHeight" value="<?= $maximumHeight ?>">
    <p></p>
